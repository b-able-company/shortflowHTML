...
function PreviewSection({ t }) {
  ...
  const teaserVideos = [
    { type: '예고편', title: '예고편', duration: '00:48', tone: 'linear-gradient(145deg, #151923 0%, #332536 48%, #9f6a55 100%)' },
    { type: '예고편', title: '예고편', duration: '00:36', tone: 'linear-gradient(145deg, #202938 0%, #475064 52%, #d0a187 100%)' },
    { type: '예고편', title: '예고편', duration: '00:42', tone: 'linear-gradient(145deg, #2b1c26 0%, #704150 54%, #dfb7a7 100%)' },
  ];
  const freeEpisodes = [
    { type: '무료회차', title: '1화', duration: '12:04' },
    { type: '무료회차', title: '2화', duration: '11:38' },
    { type: '무료회차', title: '3화', duration: '12:21' },
    { type: '무료회차', title: '4화', duration: '10:57' },
    { type: '무료회차', title: '5화', duration: '11:42' },
    { type: '무료회차', title: '6화', duration: '12:10' },
    { type: '무료회차', title: '7화', duration: '10:46' },
    { type: '무료회차', title: '8화', duration: '11:55' },
    { type: '무료회차', title: '9화', duration: '12:18' },
    { type: '무료회차', title: '10화', duration: '11:07' },
  ];
