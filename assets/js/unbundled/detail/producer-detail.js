  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        borderRadius: 10,
        border: "0.5px solid ".concat(t.line),
        background: ['#e8d6d8', '#cfd6e8', '#ead7c2', '#d6ddd8'][i],
        overflow: 'hidden'
      }
    });
  }));
...
function DetailContentTabs(_ref10) {
  var t = _ref10.t;
  var _React$useState3 = React.useState('preview'),
...
function DetailVariantA(_ref13) {
  ...
  var _React$useState5 = React.useState(false),
    ...
    fav = _React$useState6[0],
    setFav = _React$useState6[1];
  var _React$useState7 = React.useState(false),
    _React$useState8 = _slicedToArray(_React$useState7, 2),
    inCart = _React$useState8[0],
    setInCart = _React$useState8[1];
  return /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
...
function DetailVariantB(_ref14) {
  ...
  var _React$useState9 = React.useState(false),
    ...
    fav = _React$useState0[0],
    setFav = _React$useState0[1];
  var _React$useState1 = React.useState(false),
    _React$useState10 = _slicedToArray(_React$useState1, 2),
    inCart = _React$useState10[0],
    setInCart = _React$useState10[1];
...
function DetailVariantC_Actions(_ref17) {
  ...
  var _React$useState11 = React.useState(false),
    ...
    fav = _React$useState12[0],
    setFav = _React$useState12[1];
...
function DetailVariantD_RightCol(_ref19) {
  ...
  var _React$useState15 = React.useState(false),
    ...
    fav = _React$useState16[0],
    setFav = _React$useState16[1];
  var _React$useState17 = React.useState(false),
    _React$useState18 = _slicedToArray(_React$useState17, 2),
    inCart = _React$useState18[0],
    setInCart = _React$useState18[1];
  return /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minWidth: 0
